    ...
    <div>
      ...
      <div className="containerpro">
        ...
        <div className="promo-company-info">
          ...
          <h3 className="promored" style={promoCodeColor(50)}>
            50% off
          </h3>
      ...
      <div className="containerpro">
        ...
        <div className="promo-company-info">
          ...
          <h3 className="promoyellow" style={promoCodeColor(30)}>
            30% off
          </h3>
        ...
        <i
          className="fa-light fa-copy"
          onClick={() => copyToClipboard("promokoder här 2", "promo2")}
        ></i>
        {copiedText["promo2"] && (
          <span className="copied-message">Copied</span>
        )}
      ...
      <div className="containerpro">
        ...
        <div className="promo-company-info">
          ...
          <h3 className="promoyellow" style={promoCodeColor(15)}>
            15% off
          </h3>
        ...
        <i
          className="fa-light fa-copy"
          onClick={() => copyToClipboard("promokoder här", "promo1")}
        ></i>
        {copiedText["promo1"] && (
          <span className="copied-message">Copied</span>
        )}
