		...
		<main className={show ? 'space-toggle' : null}>
			<header className={`header ${show ? 'space-toggle' : null}`}>
				<div className='header-toggle' onClick={() => setShow(!show)}>
					<i
						className={`icon-bars fa-light fa-bars-staggered hamburger-menu ${
				...
				<nav className='nav'>
					<div>
						...
						<section className='contactpage'>
							<div
								className={showcontact ? 'nav-link-name-toggle' : null}
								onClick={() => setShowContact(!showcontact)}
							>
								<p className='vr-sidebar'>
									<p className='contacttext'>
										Contact us
										<i
											className={`${showcontact ? 'fa-light fa-chevron-down' : null}`}
										></i>
									</p>
								</p>
								<div
